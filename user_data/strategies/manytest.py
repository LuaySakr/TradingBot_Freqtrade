...
class MoniGoManiHyperStrategyTest(IStrategy):
    """
    ####################################################################################
    ####                                                                            ####
    ...
    buy_params = {
        'buy__downwards_trend_total_signal_needed': 14,
        'buy__sideways_trend_total_signal_needed': 22,
        'buy__upwards_trend_total_signal_needed': 81,
        'buy_downwards_trend_adx_strong_up_weight': 49,
        'buy_downwards_trend_bollinger_bands_weight': 23,
        'buy_downwards_trend_ema_long_golden_cross_weight': 68,
        'buy_downwards_trend_ema_short_golden_cross_weight': 84,
        'buy_downwards_trend_macd_weight': 78,
        'buy_downwards_trend_rsi_weight': 61,
        ...
        'buy_sideways_trend_adx_strong_up_weight': 99,
        'buy_sideways_trend_bollinger_bands_weight': 17,
        'buy_sideways_trend_ema_long_golden_cross_weight': 57,
        'buy_sideways_trend_ema_short_golden_cross_weight': 7,
        'buy_sideways_trend_macd_weight': 69,
        'buy_sideways_trend_rsi_weight': 73,
        'buy_sideways_trend_sma_long_golden_cross_weight': 16,
        'buy_sideways_trend_sma_short_golden_cross_weight': 59,
        'buy_sideways_trend_vwap_cross_weight': 50,
        'buy_upwards_trend_adx_strong_up_weight': 10,
        'buy_upwards_trend_bollinger_bands_weight': 36,
        'buy_upwards_trend_ema_long_golden_cross_weight': 46,
        'buy_upwards_trend_ema_short_golden_cross_weight': 29,
        'buy_upwards_trend_macd_weight': 20,
        'buy_upwards_trend_rsi_weight': 34,
        'buy_upwards_trend_sma_long_golden_cross_weight': 34,
    ...
    sell_params = {
        ...
        'sell__downwards_trend_total_signal_needed': 2,
        'sell__sideways_trend_total_signal_needed': 25,
        'sell__upwards_trend_total_signal_needed': 92,
        ...
        'sell_downwards_trend_sma_short_death_cross_weight': 25,
        'sell_downwards_trend_vwap_cross_weight': 61,
        'sell_sideways_trend_adx_strong_down_weight': 82,
        'sell_sideways_trend_bollinger_bands_weight': 4,
        'sell_sideways_trend_ema_long_death_cross_weight': 0,
        'sell_sideways_trend_ema_short_death_cross_weight': 61,
        'sell_sideways_trend_macd_weight': 75,
        'sell_sideways_trend_rsi_weight': 12,
        ...
        'sell_upwards_trend_adx_strong_down_weight': 57,
        'sell_upwards_trend_bollinger_bands_weight': 81,
        ...
        'sell_upwards_trend_sma_long_death_cross_weight': 48,
        'sell_upwards_trend_sma_short_death_cross_weight': 7,
        'sell_upwards_trend_vwap_cross_weight': 76
    }
    ...
    trailing_stop_positive_offset = 0.01474
