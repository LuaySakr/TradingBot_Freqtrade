...
class SampleStrategy(IStrategy):
    ...
    def populate_buy_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[
            (
                (qtpylib.crossed_above(dataframe['rsi'], 10)) &  # Signal: RSI crosses above 10
                (dataframe['tema'] <= dataframe['bb_lowerband'])   # Guard: tema below BB lower
    ...
    def populate_sell_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[
            (
                (qtpylib.crossed_above(dataframe['rsi'], 90)) &  # Signal: RSI crosses above 90
                (dataframe['tema'] >= dataframe['bb_upperband'])   # sell-macd_cross_signal
